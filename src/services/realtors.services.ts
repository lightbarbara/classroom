...
import { createRealtorQuery, deleteRealtorQuery, getAllRealtorsQuery, getRealtorByCpfQuery, getRealtorByIdQuery, updateRealtorQuery } from "../repositories/realtors.repositories";
